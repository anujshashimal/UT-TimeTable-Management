...
namespace TimeTableManagement.Forms
{
    public partial class TimeTableGenerate : Form
    {
        ...
        public TimeTableGenerate()
        {
            ...
            Rooms.DataSource = timeTableGenerate.getdatatoRooms();
            radioWeekdayLec.Checked = true;
            selectGroupYear.Text = "Y1";
            groupSem.Text = "S1";
            groupId.Text = "1";
            groupWeekday.Checked = true;
            radioWeekdayRoom.Checked = true;
        }
        ...
        private void printTimetableLecturer_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            string groupSessionsQuery = "SELECT Session.Subject, Session.subjectCode, Session.type,Session.GroupID ,Session.subgroup, Session.roomName, Session.typeduration,Session.Lecturers,SubjectTable.offYear,offSem FROM Session LEFT Join  SubjectTable on Session.subjectCode = SubjectTable.SubCode";
            SqlDataReader sessions = new SqlCommand(groupSessionsQuery, con).ExecuteReader();

            if (groupWeekday.Checked == true)
            {
                ...
                e.Graphics.DrawString(selectLecture.Text, new Font("Arial", 8, FontStyle.Regular), Brushes.Black, new RectangleF(50, 8, 150, 10), stringFormat);
                ...
                while (data.Read())
                {
                    ...
                    while (sessions.Read())
                    {
                        ...
                        System.Data.SqlClient.SqlCommand sqlCommandCheackLec = new System.Data.SqlClient.SqlCommand("SELECT Lecturer FROM sessionLecturer WHERE subjectCode = '" + subCode + "'");
                        sqlCommandCheackLec.Connection = con;
                        String Lec = sqlCommandCheackLec.ExecuteScalar().ToString();


                        if (selectLecture.Text == Lec)
                        {
                            ...
                            if (consicative >= 1)
                            {
                                ...
                                e.Graphics.DrawString(sessions.GetValue(1).ToString() + "-" + sessions.GetValue(0).ToString() + " (" + sessions.GetValue(2).ToString() + ") " + year + "." + Sem + "." + sessions.GetValue(3).ToString() + "." + sessions.GetValue(5).ToString(), new Font("Arial", 8, FontStyle.Regular), Brushes.Black, new RectangleF(SizeY, SizeX, 150, 50), stringFormat);
            ...
            else if (groupWeekend.Checked == true)
            {
                e.Graphics.DrawRectangle(Pens.Black, 10, 20, 80, 20);
                ...
                while (sessions.Read())
                {
                    ...
                    if (selectLecture.Text == Lec)
                    {
                        ...
                        System.Data.SqlClient.SqlCommand sqlCommandTimeSloats = new System.Data.SqlClient.SqlCommand("SELECT COUNT(*) FROM time_slotsWE");
                        sqlCommandTimeSloats.Connection = con;
                        int sloatcount = Convert.ToInt32(sqlCommandTimeSloats.ExecuteScalar());
                        int max = sloatcount * 50 + 40;
        ...
        private void printTimeTableGroup_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            if (groupWeekday.Checked == true)
            {
                ...
                e.Graphics.DrawString("" + selectGroupYear.Text + "." + groupSem.Text + "." + groupId.Text, new Font("Arial", 8, FontStyle.Regular), Brushes.Black, new RectangleF(50, 8, 150, 10), stringFormat);
                ...
                while (data.Read())
                {
                    ...
                    while (sessions.Read())
                    {
                        ...
                        if (year == selectGroupYear.Text && Sem == groupSem.Text && groupId.Text == sessions.GetValue(3).ToString())
                        {
                            ...
                            {
                                // e.Graphics.DrawRectangle(Pens.Black, sizeX, sizeY, 80, 50);
                                e.Graphics.DrawString(sessions.GetValue(1).ToString() + "-" + sessions.GetValue(0).ToString() + " (" + sessions.GetValue(2).ToString() + ") " + sessions.GetValue(7).ToString() + "." + sessions.GetValue(5).ToString(), new Font("Arial", 8, FontStyle.Regular), Brushes.Black, new RectangleF(SizeY, SizeX, 150, 50), stringFormat);
        ...
        private void printDocumentRoom_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            string connetionString;
            SqlConnection con;
            connetionString = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=|DataDirectory|\DBNew.mdf;Integrated Security=True;MultipleActiveResultSets = True";
            ...
            if (radioWeekdayRoom.Checked == true)
            {
                e.Graphics.DrawRectangle(Pens.Black, 10, 20, 80, 20);
                e.Graphics.DrawRectangle(Pens.Black, 90, 20, 150, 20);
                e.Graphics.DrawRectangle(Pens.Black, 240, 20, 150, 20);
                ...
                while (data.Read())
                {
                    ...
                    while (sessions.Read())
                    {
                        ...
                        if (Rooms.Text == sessions.GetValue(5).ToString())
                        {
                            System.Data.SqlClient.SqlCommand sqlCommandConsecative = new System.Data.SqlClient.SqlCommand("SELECT COUNT(*) FROM Consecutivetbl WHERE subjectcode = '" + subCode + "' AND groupid = '" + sessions.GetValue(3).ToString() + "'");
                            sqlCommandConsecative.Connection = con;
                            ...
                            {
                                // e.Graphics.DrawRectangle(Pens.Black, sizeX, sizeY, 80, 50);
                                e.Graphics.DrawString(sessions.GetValue(1).ToString() + "-" + sessions.GetValue(0).ToString() + " (" + sessions.GetValue(2).ToString() + ") " + year + "." + Sem + "." + sessions.GetValue(3).ToString() + "." + sessions.GetValue(7).ToString(), new Font("Arial", 8, FontStyle.Regular), Brushes.Black, new RectangleF(SizeY, SizeX, 150, 50), stringFormat);
            ...
            else if (radioWeekendRoom.Checked == true)
            {
                e.Graphics.DrawRectangle(Pens.Black, 10, 20, 80, 20);
                e.Graphics.DrawRectangle(Pens.Black, 90, 20, 80, 20);
                e.Graphics.DrawRectangle(Pens.Black, 170, 20, 80, 20);
        ...
        private void printPreviewDialogLecturer_Load(object sender, EventArgs e)
        {

        }

        private void buttonRoomTimeTable_Click(object sender, EventArgs e)
        {
            printPreviewDialogRoom.Document = printDocumentRoom;
            printPreviewDialogRoom.ShowDialog();
        }
    }
}
